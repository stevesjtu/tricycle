...
#define __OPC_TREECOLLIDER_H__
					...
					void	ResetCache()
							{
								...
								SepVector.pid	= 0;
								SepVector.qid	= 0;
								SepVector.SV	= Point(1.0, 0.0, 0.0);
	...
	class OPCODE_API AABBTreeCollider : public Collider
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							bool			Collide(Opcode::BVTCache& cache, const Matrix4x4* world0=null, const Matrix4x4* world1=null);
		...
		inline_				const std::vector<IceCore::contactStruct>    &GetContactArgs() const { return mPairs.GetContactArgs(); }
		...
		// Internal methods
			...
			inline_			BOOL			BoxBoxOverlap(const IceMaths::Point& ea, const IceMaths::Point& ca, const Point& eb, const Point& cb);
			inline_			BOOL			TriBoxOverlap(const IceMaths::Point& center, const Point& extents);
			inline_			BOOL			TriTriOverlap(const IceMaths::Point& V0, const Point& V1, const Point& V2, const Point& U0, const Point& U1, const Point& U2, IceCore::contactStruct &contarg);
			// Init methods

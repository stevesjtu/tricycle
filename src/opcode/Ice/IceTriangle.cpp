...
static sdword VPlaneSideEps(const Point& v, const Plane& plane, double epsilon)
{
	// Compute distance from current vertex to the plane
	double Dist = plane.Distance(v);
	// Compute side:
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double Triangle::Compacity() const
{
	double P = Perimeter();
	if(P==0.0)	return 0.0;
	return (4.0*PI*Area()/(P*P));
}
...
PartVal Triangle::TestAgainstPlane(const Plane& plane, double epsilon) const
{
...
void Triangle::ComputeMoment(Moment& m)
{
	...
	{
		const double OneOverTwelve = 1.0f / 12.0f;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double Triangle::MinEdgeLength()	const
{
	double Min = MAX_FLOAT;
	double Length01 = mVerts[0].Distance(mVerts[1]);
	double Length02 = mVerts[0].Distance(mVerts[2]);
	double Length12 = mVerts[1].Distance(mVerts[2]);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double Triangle::MaxEdgeLength()	const
{
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Triangle::ComputePoint(double u, double v, Point& pt, udword* nearvtx)	const
{
	// Compute point coordinates
	pt = (1.0 - u - v)*mVerts[0] + u*mVerts[1] + v*mVerts[2];
...
void Triangle::Inflate(double fat_coeff, bool constant_border)
{

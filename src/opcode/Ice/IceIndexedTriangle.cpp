 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::Area(const Point* verts)	const
{
	if(!verts)	return 0.0;
	const Point& p0 = verts[0];
	const Point& p1 = verts[1];
	const Point& p2 = verts[2];
	return ((p0-p1)^(p0-p2)).Magnitude() * 0.5;
}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::Perimeter(const Point* verts)	const
{
	if(!verts)	return 0.0;
	const Point& p0 = verts[0];
	const Point& p1 = verts[1];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::Compacity(const Point* verts) const
{
	if(!verts)	return 0.0;
	double P = Perimeter(verts);
	if(P==0.0)	return 0.0;
	return (4.0*PI*Area(verts)/(P*P));
}
...
void IndexedTriangle::RandomPoint(const Point* verts, Point& random)	const
{
	...
	double Alpha	= UnitRandomFloat();
	double Beta	= UnitRandomFloat();
	double Gamma	= UnitRandomFloat();
	double OneOverTotal = 1.0 / (Alpha + Beta + Gamma);
	Alpha	*= OneOverTotal;
	Beta	*= OneOverTotal;
	Gamma	*= OneOverTotal;
...
//	Point Base = (p0 + p1 + p2)*INV3;
	...
	// Backface culling
//	return (Normal | (source - Base)) >= 0.0;
	return (Normal | (source - p0)) >= 0.0;

// Same as: (but a bit faster)
//	Plane PL(verts[mVRef[0]], verts[mVRef[1]], verts[mVRef[2]]);
//	return PL.Distance(source)>0.0;
}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::ComputeOcclusionPotential(const Point* verts, const Point& view)	const
{
	if(!verts)	return 0.0;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::MinEdgeLength(const Point* verts)	const
{
	if(!verts)	return 0.0;

	double Min = MAX_FLOAT;
	double Length01 = verts[0].Distance(verts[1]);
	double Length02 = verts[0].Distance(verts[2]);
	double Length12 = verts[1].Distance(verts[2]);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::MaxEdgeLength(const Point* verts)	const
{
	if(!verts)	return 0.0;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::ComputePoint(const Point* verts, double u, double v, Point& pt, udword* nearvtx)	const
{
	// Checkings
	if(!verts)	return;
	...
	{
		double NormU = u.Magnitude();	// |u|
		double NormV = v.Magnitude();	// |v|
		double Product = NormU*NormV;	// |u||v|
		if(Product==0.0)	return 0.0;
		double OneOverProduct = 1.0 / Product;

		// Cosinus
		double Cosinus = (u|v) * OneOverProduct;

		// Sinus
		Point w = u^v;
		double NormW = w.Magnitude();

		double AbsSinus = NormW * OneOverProduct;

		// Remove degeneracy
		if(AbsSinus > 1.0) AbsSinus = 1.0;
		if(AbsSinus < -1.0) AbsSinus = -1.0;

		if(Cosinus>=0.0)	return asin(AbsSinus);
		else				return (PI-asin(AbsSinus));
	}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double IndexedTriangle::Angle(const IndexedTriangle& tri, const Point* verts)	const
{
	// Checkings
	if(!verts)	return 0.0;

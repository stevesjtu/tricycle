...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	#define	HALFPI				1.57079632679489661923									//!< 0.5 * PI
	#define	TWOPI				6.28318530717958647692									//!< 2.0 * PI
	#define	INVPI				0.31830988618379067154									//!< 1.0 / PI

	#define	RADTODEG			57.2957795130823208768									//!< 180.0 / PI, convert radians to degrees
	#define	DEGTORAD			0.01745329251994329577									//!< PI / 180.0, convert degrees to radians

	#define	EXP					2.71828182845904523536									//!< e
	#define	INVLOG2				3.32192809488736234787									//!< 1.0 / log10(2)
	#define	LN2					0.693147180559945										//!< ln(2)
	#define	INVLN2				1.44269504089											//!< 1.0f / ln(2)

	#define	INV3				0.33333333333333333333									//!< 1/3
	#define	INV6				0.16666666666666666666									//!< 1/6
	#define	INV7				0.14285714285714285714									//!< 1/7
	#define	INV9				0.11111111111111111111									//!< 1/9
	#define	INV255				0.00392156862745098039									//!< 1/255

	#define	SQRT2				1.41421356237											//!< sqrt(2)
	#define	INVSQRT2			0.707106781188											//!< 1 / sqrt(2)

	#define	SQRT3				1.73205080757											//!< sqrt(3)
	#define	INVSQRT3			0.577350269189											//!< 1 / sqrt(3)
...
//	DECLARE_ICE_HANDLE(KID);
	...
	#define	MAX_FLOAT				DBL_MAX						//!< max possible float value
	#define	MIN_FLOAT				(-DBL_MAX)					//!< min possible loat value
	#define IEEE_1_0				0x3ff0000000000000					//!< integer representation of 1.0
	#define IEEE_255_0				0x406fe00000000000					//!< integer representation of 255.0
	#define IEEE_MAX_FLOAT			0x7fefffffffffffff					//!< integer representation of MAX_FLOAT
	#define IEEE_MIN_FLOAT			0x0010000000000000					//!< integer representation of MIN_FLOAT

...
#define __ICESEGMENT_H__
	...
	class ICEMATHS_API Segment
	{
		...
		inline_			double	ComputeLength()					const	{ return mP1.Distance(mP0);			}
		inline_			double	ComputeSquareLength()			const	{ return mP1.SquareDistance(mP0);	}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			void	ComputePoint(Point& pt, double t)	const	{	pt = mP0 + t * (mP1 - mP0);		}

						double	SquareDistance(const Point& point, double* t=null)	const;
		inline_			double	Distance(const Point& point, double* t=null)			const			{ return sqrt(SquareDistance(point, t));	}

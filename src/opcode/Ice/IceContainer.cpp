...
udword IceCore::Container::mNbContainers = 0;
udword IceCore::Container::mUsedRam = 0;
#endif
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Container::Container(udword size, double growth_factor) : mMaxNbEntries(0), mCurNbEntries(0), mEntries(null), mGrowthFactor(growth_factor)
{
#ifdef CONTAINER_STATS
	mNbContainers++;
	mUsedRam+=sizeof(Container);
...
bool Container::Resize(udword needed)
{
	...
	// Get more entries
	mMaxNbEntries = mMaxNbEntries ? udword(double(mMaxNbEntries)*mGrowthFactor) : 2;	// Default nb Entries = 2

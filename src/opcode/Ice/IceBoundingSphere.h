...
#define __ICEBOUNDINGSPHERE_H__
	...
	class ICEMATHS_API Sphere
	{
		...
		inline_					Sphere()																		{}
		//! Constructor
		inline_					Sphere(const Point& center, double radius) : mCenter(center), mRadius(radius)	{}
		//! Constructor
		...
		inline_	double			GetRadius()						const		{ return mRadius; }

		inline_	const Point&	Center()						const		{ return mCenter; }
		inline_	double			Radius()						const		{ return mRadius; }

		inline_	Sphere&			Set(const Point& center, double radius)		{ mCenter = center; mRadius = radius; return *this; }
		inline_	Sphere&			SetCenter(const Point& center)				{ mCenter = center; return *this; }
		inline_	Sphere&			SetRadius(double radius)						{ mRadius = radius; return *this; }
		...
		inline_	bool			Contains(const Sphere& sphere)	const
								{
									...
									double r = mRadius - sphere.mRadius;

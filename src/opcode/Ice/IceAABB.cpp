 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
double AABB::MakeCube(AABB& cube) const
{
...
void AABB::MakeSphere(Sphere& sphere) const
{
	...
	sphere.mRadius = sphere.mCenter.Magnitude() * 1.00001;	// To make sure sphere::Contains(*this)	succeeds
...
bool AABB::ComputePlanes(Plane* planes)	const
{
	...
	// Writes normals
	planes[0].n = Point(1.0, 0.0, 0.0);
	planes[1].n = Point(-1.0, 0.0, 0.0);
	planes[2].n = Point(0.0, 1.0, 0.0);
	planes[3].n = Point(0.0, -1.0, 0.0);
	planes[4].n = Point(0.0, 0.0, 1.0);
	planes[5].n = Point(0.0, 0.0, -1.0);
...
{
	static const double VertexNormals[] = 
	{
...
{
	static const double EdgeNormals[] = 
	{
...
//double width, double height, int& num)
double AABB::ComputeBoxArea(const Point& eye, const Matrix4x4& mat, double width, double height, sdword& num)	const
{
	const sbyte* Outline = ComputeOutline(eye, num);
	if(!Outline)	return -1.0;
	...
	double Sum = (dst[num-1][0] - dst[0][0]) * (dst[num-1][1] + dst[0][1]);

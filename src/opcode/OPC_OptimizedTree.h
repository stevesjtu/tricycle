...
#define __OPC_OPTIMIZEDTREE_H__
	...
	class OPCODE_API AABBCollisionNode
	{
		...
		inline_			double				GetVolume()		const	{ return mAABB.mExtents.x * mAABB.mExtents.y * mAABB.mExtents.z;	}
		inline_			double				GetSize()		const	{ return mAABB.mExtents.SquareMagnitude();	}

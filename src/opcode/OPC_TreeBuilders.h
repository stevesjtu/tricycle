...
#define __OPC_TREEBUILDERS_H__
	...
	class OPCODE_API AABBTreeBuilder
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual						double			GetSplittingValue(udword index, udword axis)	const	= 0;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		virtual						double			GetSplittingValue(const udword* primitives, udword nb_prims, const AABB& global_box, udword axis)	const
													{
	...
	class OPCODE_API AABBTreeOfVerticesBuilder : public AABBTreeBuilder
	{
		...
		override(AABBTreeBuilder)	double			GetSplittingValue(udword index, udword axis)									const;
		override(AABBTreeBuilder)	double			GetSplittingValue(const udword* primitives, udword nb_prims, const AABB& global_box, udword axis)	const;
